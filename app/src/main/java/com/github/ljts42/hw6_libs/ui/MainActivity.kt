...
import com.github.ljts42.hw6_libs.data.ChatDao
import com.github.ljts42.hw6_libs.data.ChatDatabase
import com.github.ljts42.hw6_libs.data.DataType
import com.github.ljts42.hw6_libs.data.MessageModel
import com.github.ljts42.hw6_libs.databinding.ActivityMainBinding
import com.github.ljts42.hw6_libs.network.*
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, intent: Intent?) {
        ...
        try {
            CoroutineScope(Dispatchers.IO).launch {
                if (requestCode == pickImageRequest && resultCode == Activity.RESULT_OK && intent != null && intent.data != null) {
                    val bitmap = MediaStore.Images.Media.getBitmap(contentResolver, intent.data)
                    if (bitmap != null) {
                        val messageBody = moshi.adapter(Message::class.java)
                            .toJson(Message(from = Constants.USERNAME))
